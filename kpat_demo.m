...
tree = kpat_buildtree(X,plot_stuff);
...
%     point=0.6*ones(1,dimen);
    ...
    [index_vals,vec_vals, dist_vals, calculationtimesk]  = pat_knn(tree,point,num_of_points,plot_stuff);
    index_vals
    calculationtimesk
    sum_time = sum_time + calculationtimesk;
    if (plot_stuff);
